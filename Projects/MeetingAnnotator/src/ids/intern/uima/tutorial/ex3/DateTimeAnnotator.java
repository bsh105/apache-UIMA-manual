package ids.intern.uima.tutorial.ex3;
...
import ids.intern.uima.tutorial.DateAnnot;
import ids.intern.uima.tutorial.DateTimeAnnot;
import ids.intern.uima.tutorial.TimeAnnot;
...
public class DateTimeAnnotator extends JCasAnnotator_ImplBase {
  ...
  public void process(JCas aJCas) {
    ...
    boolean timeWanted = resultSpec.containsType("ids.intern.uima.tutorial.TimeAnnot", aJCas.getDocumentLanguage());
    boolean dateWanted = resultSpec.containsType("ids.intern.uima.tutorial.DateAnnot", aJCas.getDocumentLanguage());
    ...
    if (!timeWanted && !dateWanted && !warningMessageShown) {
      String m = String.format(
        ...
        "  ids.intern.uima.tutorial.TimeAnnot nor%n" +
        "  ids.intern.uima.tutorial.DateAnnot" +
